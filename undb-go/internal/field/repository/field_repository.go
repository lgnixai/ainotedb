...
func (r *fieldRepository) GetByID(ctx context.Context, id string) (*model.Field, error) {
...
func (r *fieldRepository) GetByTableID(ctx context.Context, tableID string) ([]*model.Field, error) {
...
func (r *fieldRepository) Delete(ctx context.Context, id string) error {
